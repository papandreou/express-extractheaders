...
module.exports = function (config) {
  ...
  return function expressExtractHeaders(req, res, next) {
    ...
    if (
      ...
      hijackResponse(res, function (err, responseBody, res) {
        if (err) {
          // This cannot happen. Always called with null value. Will be
          // addressed before a new major version is released.
          return next(err);
        }
